...
flowchart TD
  ...
  M["[model] Sort and re-plan call: claude-sonnet-5, max_tokens 4,096,
...
| --- | --- | --- | --- | --- |
| 2026-09-22 | anxious, native, x1 | Parse | 20 of 20 native, 0 recovered, 0 failed, 0 cut off at 4,096 | 0.5739 for the 20 plans |
...
| 2026-09-22 | anxious, native, x1 | Output and latency | 944 to 3,542 output tokens per plan (the two middle plans ran 1,668 and 1,719), 85% of them thinking tokens; mean latency 19.3 s; cache reads on 95% of calls | 0.0152 to 0.0544 per plan, median 0.0266, mean 0.0287 |
...
| The reply is cut off before the JSON closes | 0 of 20 at 4,096; 483 of 500 native and 477 of 500 prompt at 1,024, and 6 of 20 at 2,048, 2026-09-22 | the parser reports `failed` with "cut off"; the Worker answers 502 with the parse path; the evals count `stop_reason: max_tokens` as a hard fail | the whole call's tokens for no plan |
...
- The five-state, two-contract grid at the 4,096 budget (1,000 calls); only anxious and native have been run there.
